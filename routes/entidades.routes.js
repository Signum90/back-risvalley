...
router.post("/create/dashboard", Middlewares.validateAdminMiddleware,
  ...
  EntidadesValidator.entidadesValidator,
  entidadesController.saveEntidad);
router.post("/create", Middlewares.validateJWTMiddleware,
  multerConfig.upload.single('logo'),
  EntidadesValidator.entidadesValidatorNotUser,
  entidadesController.saveEntidad);
router.put("/:idEntidad/update", Middlewares.validateJWTMiddleware,
  EntidadesValidator.entidadesValidatorDinamic,
  async (req, res) => await entidadesController.updateFieldEntidad(req, res))
router.put("/:idEntidad/update-logo", Middlewares.validateJWTMiddleware,
  multerConfig.upload.single('logo'),
  EntidadesValidator.logoUpdateValidator,
...
router.delete("/:idEntidad/delete", Middlewares.validateJWTMiddleware,
  EntidadesValidator.deleteEntidadValidator,
